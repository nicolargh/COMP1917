...
void testList (void){
    ...
    printf ("\nTest 5:  A list containing three nodes [21,24,22] = [21,22,24]\n");
    sourceList->head = &nodes[0];
    nodes[0].value = 21;
    nodes[1].value = 24;
    nodes[2].value = 22;
    ...
    assert (sourceList->head->next->next->value == 24);
    assert (sourceList->head->next->next->next == NULL);

    printf ("\nTest 6:  A list containing three nodes [22,21,20] = [20,21,22]\n");
    sourceList->head = &nodes[0];
    nodes[0].value = 22;
    nodes[1].value = 21;
    nodes[2].value = 20;
    ...
    assert (sourceList->head == &nodes[2]);  
    assert (sourceList->head->value == 12);
    assert (sourceList->head->next == &nodes[1]);
    assert (sourceList->head->next->value == 33);
    assert (sourceList->head->next->next == &nodes[0]);
    ...
    assert (sourceList->head == &nodes[4]);  
    assert (sourceList->head->value == 1);
    assert (sourceList->head->next == &nodes[8]);
    assert (sourceList->head->next->value == 2);
    assert (sourceList->head->next->next == &nodes[6]);
    assert (sourceList->head->next->next->value == 21);
    assert (sourceList->head->next->next->next == &nodes[2]);
    assert (sourceList->head->next->next->next->value == 32);
    ...
    assert (sourceList->head->next->next->next->next->next->next == &nodes[7]);
    assert (sourceList->head->next->next->next->next->next->next->value == 77);
    assert (sourceList->head->next->next->next->next->next->next->next == &nodes[3]);
    assert (sourceList->head->next->next->next->next->next->next->next->value == 90);
    assert (sourceList->head->next->next->next->next->next->next->next->next == &nodes[5]);
    assert (sourceList->head->next->next->next->next->next->next->next->next->value == 232);
